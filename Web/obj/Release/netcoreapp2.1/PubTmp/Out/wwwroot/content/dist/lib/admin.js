...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, s = layui.view, l = layui.device(),
        ...
        x = {
            ...
            resize: function (e) {//绑定窗体大小变化函数,当body的内容改变是相应的做出改变
    ...
    !function () {
        ...
        e.theme && x.theme(e.theme), o.addClass("layui-layout-body"), 
    ...
    var k = function (e) {//变换路由的hash值和body显示的内容
        var a = e.attr("lay-id"), i = e.index();
        console.log(i);
        x.tabsBodyChange(i), location.hash = a === n.entry ? "/" : a
    }, 
    z = "#LAY_app_tabsheader>li";
    o.on("click", z, function () {//tabs的页面标签栏点击
        var e = a(this), i = e.index();//获取标签的索引
