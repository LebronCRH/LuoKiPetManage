    ...
    .define(["setter", "admin"], function (e) {
        var a = layui.setter,
            ...
            o = function () {
                ...
                //下面这段的意思为t.type=tab且admin中的tabsbody的第一个Html()有的话则执行?后的第一个即切换tabsBody页面否则则渲染r.join("/")页面
                ...
                (l().render(r.join("/")).then(function (l) {
                    ...
                    a.pageTabs && "/" !== y && (o || (s(d).append('<div class="layadmin-tabsbody-item layui-show"></div>'), //前面的each遍历寻找之前是不有有打开过该页面标签tab，根据o的true/false值来决定是否执行下面一个tabAdd方法
                        t.index = r.length, 
                        n.tabAdd(u, {
                    ...
                    this.container = i.tabsBody(t.index), n.tabChange(u, y), i.tabsBodyChange(t.index)
                        ...
                        n.render("breadcrumb", "breadcrumb"), //面包屑组件
            ...
            r = function (e) {
                ...
                if (layui.each(a.indPage, function (e, a) {
                    ...
                    // layui.config({base: a.base + "controller/"}), 
                    n || "/user/login" === d) 
                    ...
                    //"console" === i.pageType ? o() : r.render("layout").done(function () {//第一次加载的时候由于还没设置pageType为console所以加载的是layout模板
                    //    o(), layui.element.render(), i.screen() < 2 && i.sideFlexible(), i.pageType = "console"
                    //})//第一次执行的话没有pageType="console"，执行后半段加载layout模板文件
                    "console" === i.pageType ? o() : (o(), layui.element.render(), i.screen() < 2 && i.sideFlexible(), i.pageType = "console")
                }
            },
            d = "#LAY_app_body",
