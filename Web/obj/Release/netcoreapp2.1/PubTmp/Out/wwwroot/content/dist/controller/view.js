...
;layui.define(["laytpl", "layer"], function (e) {
    ...
    //t代表jquery,a代表laytpl,n代表layui的弹出层模块,r代表config配置,o代表设备信息和打印模块
    i = function (e) {
        return new d(e)
    }, 
    s = "LAY_app_body", 
    d = function (e) {
        this.id = e, this.container = t("#" + (e || s))//id用来表示页面/路由路径，container用来表示显示视图的容器
    };
    ...
    //t代表jquery,a代表laytpl,n代表layui的弹出层模块,r代表config配置,o代表设备信息和打印模块
    i.req = function (e) {
        var a = e.success, n = (e.error, r.request), o = r.response, 
        s = function () {
    ...
    d.prototype.render = function (e, a) {
        ...
        return  t("#" + s).children(".layadmin-loading").remove(), i.loading(n.container), 
        t.ajax({
            url: e,
            type: "get",
            // dataType: "html",
